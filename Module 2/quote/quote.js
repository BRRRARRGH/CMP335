async function FetchData() /* Called by the button in the HTML Main page */
{
    ...
    let prompt = `https://api.quotable.io/quotes/random?minLength=${minLength}&maxLength=${maxLength}`; 
